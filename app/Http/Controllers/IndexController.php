...
class IndexController extends Controller
{
    ...
    {
        if (DB::table('countview')->get()->isEmpty()) {
            DB::table('countview')->insert([
                'count' => 1
            ]);
        } else {
            $count = DB::table('countview')->get()->pluck('count');
            $count['0'] += 1;
            DB::table('countview')->update(['count' => $count['0']]);
        }
        ...
        return view('index.index', compact('productList', 'menuList', 'slideList', 'AnnouncementList', 'FooterList', 'NewProduct', 'NewMenu', 'OutSiteLink','CountResult'));
    }
