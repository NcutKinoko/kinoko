...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $product = DB::table('product')
            ...
            ->select('product.id','product.name','category.name as categoryName',DB::raw('(CASE WHEN product.category_id = "0" THEN "此產品未分類" ELSE category.name END) AS categoryName'),'product.price','product.inventory','product.size','product.introduction','product.img')
        ->get();
